                                        ...
                                        <div className="flex flex-col items-center justify-center py-8 mx-auto  lg:py-0">
                                            ...
                                            <div className="w-full  rounded-lg md:mt-0 sm:max-w-md xl:p-0 ">
                                                ...
                                                <form className="space-y-4 md:space-y-6" action="#">
                                                    ...
                                                    <button onClick={()=>{buyNow(); closeModal()}} type="button" className="focus:outline-none w-full text-white bg-red-600 hover:bg-red-800  outline-0 font-medium rounded-lg text-sm px-5 py-2.5 ">Order Now</button>
