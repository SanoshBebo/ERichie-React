  ...
  return (
    <div className='bg-white sticky top-0 z-50'>
            ...
            >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl" style={{ backgroundColor: mode === 'dark' ? 'rgb(40, 44, 52)' : '', color: mode === 'dark' ? 'white' : '', }}>
                ...
                <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                  ...
                  <Link to={'/shop09/allproducts'} className="text-sm font-medium text-gray-900 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                    All Products
                  </Link>
                  ...
                  {user?.user?.email === "sashfiretest1@gmail.com" ? <div className="flow-root">
                    <Link to={'shop09/dashboard'} className="-m-2 block p-2 font-medium text-gray-900" style={{ color: mode === 'dark' ? 'white' : '', }}>
                      Admin
                    </Link>
                  </div> : ""}
      ...
      <header className="relative bg-white">
        ...
        <nav aria-label="Top" className="bg-red-200 px-4 sm:px-6 lg:px-8 shadow-xl " style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '', }}>
          <div className="">
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <Link to={'/shop09'} className='flex'>
                  <div className="flex ">
                    <h1 className=' text-2xl font-bold text-black  px-2 py-1 rounded' style={{ color: mode === 'dark' ? 'white' : '', }}>Shank Mobiles</h1>
                  </div>
                </Link>
              </div>
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  ...
                  <Link to={'/shop09/admin/overall-analytics'} className="text-sm font-medium text-black-700 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                    E-Ritchie Analytics
                  </Link>
                ...
                <div className="ml-4 flow-root lg:ml-6">
                  <Link to={'/erichie/cart'} className="group -m-2 flex items-center p-2" style={{ color: mode === 'dark' ? 'white' : '', }}>
