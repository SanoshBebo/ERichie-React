                  ...
                  >
                    ...
                    >
                      ...
                      <div className="p-5 border-t-2">
                        <h2
                          className="tracking-widest text-xs title-font font-medium text-black-400 mb-1"
                          style={{ color: mode === "dark" ? "white" : "" }}
                        >
                          Shank Mobiles
                        </h2>
                        ...
                        <div className=" flex justify-center">
                          <button
                            ...
                            className="focus:outline-none text-white bg-red-500 hover:bg-red-700 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm w-full  py-2"
                          >
                            Add To Cart
                          </button>
                        </div>
