...
const MobileCategory = () => {
  ...
  return (
    ...
    <div className="flex-row min-h-screen border border-opacity-50">
      ...
      <div className="navigation-bar p-4 bg-gray-200 flex justify-between">
        ...
        <Link to="/shop09">
          ...
          <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full ml-2 transition duration-300">
        ...
        <Link to="/shop10/home">
          ...
          <button className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-full ml-2 transition duration-300">
        ...
        <Link to="/shop11">
          ...
          <button className="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded-full ml-2 transition duration-300">
        ...
        <Link to="/shop12/customer">

          <button className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-full ml-2 transition duration-300">
