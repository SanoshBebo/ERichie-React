...
function AddProduct() {
  ...
  useEffect(() => {
    ...
    if (userData && userData.email == "rethuadmin@gmail.com") {
  ...
  return (
    <div className="add-product-pagess">
      <div className="add-product-containerss">
        <button
          className="inventory-buttonss"
          onClick={() => DeadEyeInventory()}
        >
          Dead_eye_Inventory
        </button>

        <button class="custom-button">
          <a href="/shop05/admin/overall-report">Overall Report</a>
        </button>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (/^\d+$/.test(inputValue)) {
                      setProduct({ ...product, stock: inputValue });
                    }
                  }}
                />
              </div>
      ...
      <div className="product-lists">
        ...
        <div className="product-boxess">
          {currentProducts.map((product) => (
            <div className="product-boxss" key={product.id}>
